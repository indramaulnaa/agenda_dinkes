...
<head>
    ...
    <title>Buat Agenda Baru - Admin Panel</title>
    ...
    <style>
        ...
        /* SIDEBAR (CSS dipersingkat, sama seperti index) */
        ...
        .btn-simpan { background-color: #198754; border: none; padding: 10px 30px; font-weight: 600; }
...
<div class="wrapper">
    ...
    <div id="content">
        <div class="main-header">
            <h4 class="fw-bold m-0">Buat Agenda Baru</h4>
        </div>
