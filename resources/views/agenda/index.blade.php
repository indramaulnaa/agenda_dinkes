...
@section('content')
    ...
    <style>
        ...
        .fc .fc-button-primary:not(:disabled).fc-button-active { background-color: transparent !important; color: #111827 !important; font-weight: 800 !important; }
        .agenda-list-card { background: white; border: 1px solid #e5e7eb; border-radius: 12px; padding: 20px; margin-bottom: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.02); transition: all 0.2s ease-in-out; cursor: pointer; }
        ...
        .bg-ongoing { background-color: #fff3cd; color: #664d03; } .bg-scheduled { background-color: #cfe2ff; color: #084298; } .bg-selesai { background-color: #d1e7dd; color: #0f5132; } 
                ...
                eventClick: function(info) {
                    ...
                    if (props.can_edit) {
                        ...
                        document.getElementById('btnOpenEdit').onclick = function() {
                            ...
                            document.getElementById('editStart').value = timeStr; if(document.getElementById('editStart')._flatpickr) document.getElementById('editStart')._flatpickr.setDate(timeStr);
                            if(event.end) {
                                ...
                                document.getElementById('editEnd').value = endStr; if(document.getElementById('editEnd')._flatpickr) document.getElementById('editEnd')._flatpickr.setDate(endStr);
                            } else {
                                document.getElementById('editEnd').value = ''; if(document.getElementById('editEnd')._flatpickr) document.getElementById('editEnd')._flatpickr.clear();
                            }
